...
public class Solution {
    ...
    public static String weekDayOfBirthday(String birthday, String year)
    {
        ...
        String date = birthday.substring(0, 6) + year;
        DateTime datetime = null;
        try
        {
            datetime = new DateTime(format.parse(date));
        }
        ...
        DateFormat formatItalian = new SimpleDateFormat("EEEE", Locale.ITALY);

        return formatItalian.format(datetime.toDate());
