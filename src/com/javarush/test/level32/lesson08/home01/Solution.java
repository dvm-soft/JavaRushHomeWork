...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        CustomInvocationHandler customInvocationHandler = new CustomInvocationHandler(origin);

        SomeInterfaceWithMethods proxy = (SomeInterfaceWithMethods) Proxy.newProxyInstance(classLoader, interfaces, customInvocationHandler);
        return proxy;
    }
}
