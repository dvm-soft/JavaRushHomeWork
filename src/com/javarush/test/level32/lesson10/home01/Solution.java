...
public class Solution {
    ...
    public static Thread CLIENT_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try
            {
                Registry localeRegistry = LocateRegistry.getRegistry(null, 2099);
                DoubleString servise = (DoubleString) localeRegistry.lookup(UNIC_BINDING_NAME);
                //DoubleString servise = (DoubleString) registry.lookup(UNIC_BINDING_NAME);
                String result = servise.doubleString("String");
