...
public class NodeHelperTestSolution {
    ...
    public static RedBlackTree.Color getNodeColor(RedBlackTree.Node node) throws
            NoSuchFieldException,
            IllegalAccessException
    {
        Field nodeField = node.getClass().getDeclaredField("color");
        nodeField.setAccessible(true);
        return (RedBlackTree.Color)  nodeField.get(node);
    }

    public static int getNodeIntValue(RedBlackTree.Node node) throws
            NoSuchFieldException,
            IllegalAccessException
    {
