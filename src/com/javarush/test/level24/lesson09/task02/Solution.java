    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (result != 0)
                    return result;
                result = (-1)*((Date) stock1.get("date")).compareTo((Date) stock2.get("date"));
                if (result != 0)
                    return result;
                Double profit1 = !stock1.containsKey("last") ? ((double) stock1.get("change")) : (((double) stock1.get("last")) - ((double) stock1.get("open")));
                Double profit2 = !stock2.containsKey("last") ? ((double) stock2.get("change")) : (((double) stock2.get("last")) - ((double) stock2.get("open")));
                result = profit1.compareTo(profit2);
                return result*(-1);
            }
        });
    }
