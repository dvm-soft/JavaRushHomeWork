...
public class Solution {
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            sb.append(string1.number);
            sb.append("\n");
            sb.append(string2.number);
            sb.append("\n");
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            java.lang.String[] str = new java.lang.String(buff).split("\n");
            int tmp = countStrings;
            countStrings = Integer.parseInt(str[0])-1;
            this.string1 = new String();
            countStrings = Integer.parseInt(str[1])-1;
