...
public class Solution {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while ((ivanov.getCountSpeaches() + petrov.getCountSpeaches() + sidorov.getCountSpeaches()) < (long) totalCountSpeeches) {
    ...
    public static class Politic extends Thread {
        ...
        public void run() {
            while (countSounds < (long)(totalCountSpeeches * soundsInOneSpeech)) {
                countSounds++;
            }
        }

        public long getCountSpeaches() {
