...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        {
            factoryNumber = factoryCounter.addAndGet(1);
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String threadName = String.format("%s-pool-%s-thread-%s", thread.getThreadGroup().getName(), factoryNumber, threadCounter.addAndGet(1));
